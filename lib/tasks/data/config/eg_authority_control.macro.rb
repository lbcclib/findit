...
AUTHORIZED_BIB_TAGS = %w[100 110 111 600 610 611 630 650 651 700 710 711 730 800 810 811 830].freeze
INTERESTING_AUTHORITY_TAGS = %w[400 410 411 430 447 448 450 451 455 500 510 511 530 550 551
                                555 663 664 665 666 681 682 700 710 711 730 747 748 750 751
                                755 780 781 782].freeze
USELESS_AUTHORITY_SUBFIELD_CODES = %w[0 i w].freeze
    ...
    module EgAuthorityControl
      ...
      def fetch_and_extract_authority_record(authority_id)
        ...
        @@cache.fetch(cache_id(authority_id)) do
          ...
          rescue Errno::ECONNREFUSED, OpenSSL::SSL::SSLError, OpenURI::HTTPError, Net::OpenTimeout, SocketError
            []
          end
        end
      end
